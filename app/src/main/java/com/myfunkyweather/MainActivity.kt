...
class MainActivity : AppCompatActivity() {
    ...
    private var weather_url1 = ("http://api.weatherbit.io/v2.0/current")

    // api id for url
    private var api_id1 = ("cf265e5633ff4a199d5398bae3cc2f40")
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val btVar1 = findViewById<Button>(R.id.btVar1)
